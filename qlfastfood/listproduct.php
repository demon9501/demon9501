                     ...
                     <div class="header_bottom">
                        <ul class="option">
                           ...
                           <li class="option-cart">
                              ...
                              <ul class="option-cart-item">
                                 ...
                                 <li><span class="total"><strong> </strong></span><button class="checkout" onClick="location.href='checkout.html'">CheckOut</button></li>
                              </ul>
                           </li>
                        </ul>
                        ...
                        <div class="navbar-collapse collapse">
                           <ul class="nav navbar-nav">
                              ...
                              <li><a href="productgird.html">ĐỒ ĂN NHANH</a></li>
                              <li><a href="productlitst.html">NƯỚC UỐNG</a></li>
                              <li class="dropdown">
...
//Lay danh sach danh muc tu database
                              ...
                              <li><a href="productgird.html">DỊCH VỤ</a>
                              <li><a href="productgird.html">THANHT TOÁN</a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
                  ...
                  <ul id="hot">
                     <li>
                        ...
                        <div class="row">
                                  ...
                                  <?php
//Lay danh sach danh muc tu database
    $sql     = 'SELECT price,product.id,thumbnail,title,category.name category_name FROM product left join category on product.id_category = category.id WHERE category.id = '.$_GET['id'].'';
      $index = 1;
    ...
    <div class="products">                                                                                            
           <div class="thumbnail"><a href="details.php?id= '.$item['id'].'"> <img src="'.$item['thumbnail'].'" /></a></div>   
          <div class="productname"><a href="details.php? '.$item['id'].'">'.$item['category_name'].'</a></div>  
